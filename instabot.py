...
#target account
target_account = ""  #add target instagram account
...
for username, password in accounts.items():
    ...
    #like a post
    try:
        my_bot.like_user(target_account, amount=1, filtration=False)
    except Exception:
        print(Exception)

    #comment
    try:
        user_id = my_bot.get_user_id_from_username(target_account)
